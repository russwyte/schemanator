...
/** Provides type-safe example values for a field.
  *
  * This annotation captures both the values and their schema, allowing for proper JSON encoding of complex types.
  *
  * Example:
  * {{{
  *   case class Product(
  ...
  *   The example values
  * @tparam A
  *   The type of the values (must have a Schema instance)
  */
...
/** Provides a default value for a field with type-safe encoding.
  *
  * This annotation captures both the value and its schema, allowing for proper JSON encoding of complex types.
  *
  * Example:
  * {{{
  *   case class Config(
  ...
  *   The default value
  * @tparam A
  *   The type of the default value (must have a Schema instance)
  */
